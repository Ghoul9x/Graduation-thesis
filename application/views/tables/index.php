      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <?php if(in_array('createTable', $user_permission)): ?>
            <button class="btn btn-primary" data-toggle="modal" data-target="#addModal">Thêm bàn</button>
            <br /> <br />
      ...
      <form role="form" action="<?php echo base_url('tables/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name">Tên bàn</label>
            <input type="text" class="form-control" id="table_name" name="table_name" placeholder="Điền tên bàn" autocomplete="off">
          </div>

          <div class="form-group">
            <label for="brand_name">Số ghế ngồi</label>
            <input type="text" class="form-control" id="capacity" name="capacity" placeholder="Điền số ghế ngồi" autocomplete="off">
          </div>
          ...
          <div class="form-group">
            <label for="active">Cửa hàng</label>
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('tables/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name">Tên bàn</label>
            <input type="text" class="form-control" id="edit_table_name" name="edit_table_name" placeholder="Điền tên bàn" autocomplete="off">
          </div>

          <div class="form-group">
            <label for="brand_name">Số ghế ngồi</label>
            <input type="text" class="form-control" id="edit_capacity" name="edit_capacity" placeholder="Điền số ghế ngồi" autocomplete="off">
          </div>

          <div class="form-group">
            <label for="active">Tình trạng</label>
            <select class="form-control" id="edit_available" name="edit_available">
