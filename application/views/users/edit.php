          ...
          <div class="box">
            ...
            <form role="form" action="<?php base_url('users/create') ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="groups">Cửa hàng</label>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="fname" name="fname" placeholder="Tên" value="<?php echo $user_data['firstname'] ?>" autocomplete="off">
                </div>

                <div class="form-group">
                  <label for="lname">Họ</label>
                  <input type="text" class="form-control" id="lname" name="lname" placeholder="Họ" value="<?php echo $user_data['lastname'] ?>" autocomplete="off">
                </div>

                <div class="form-group">
                  <label for="phone">Số điện thoại</label>
                  <input type="text" class="form-control" id="phone" name="phone" placeholder="Số điện thoại" value="<?php echo $user_data['phone'] ?>" autocomplete="off">
                </div>
