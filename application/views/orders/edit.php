      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Sửa đặt bàn</h3>
          </div>
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="date" class="col-sm-12 control-label">Ngày: <?php date_default_timezone_set('Asia/Ho_Chi_Minh'); echo date('d-m-Y') ?></label>
                </div>
                <div class="form-group">
                  <label for="time" class="col-sm-12 control-label">Giờ: <?php date_default_timezone_set('Asia/Ho_Chi_Minh'); echo date('h:i a') ?></label>
                </div>

                <div class="col-md-4 col-xs-12 pull pull-left">

                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">Bàn</label>
                    <div class="col-sm-7">
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label">Tổng tiền</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    <label for="vat_charge" class="col-sm-5 control-label">Thuế <?php echo $company_data['vat_charge_value'] ?> %</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    <label for="net_amount" class="col-sm-5 control-label">Tổng hoá đơn</label>
                    <div class="col-sm-7">
