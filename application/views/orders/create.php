      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Thêm đặt bàn</h3>
          </div>
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="gross_amount" class="col-sm-12 control-label">Ngày: <?php date_default_timezone_set('Asia/Ho_Chi_Minh'); echo date('d-m-Y') ?></label>
                </div>
                <div class="form-group">
                  <label for="gross_amount" class="col-sm-12 control-label">Giờ: <?php date_default_timezone_set('Asia/Ho_Chi_Minh'); echo date('h:i a') ?></label>
                </div>
