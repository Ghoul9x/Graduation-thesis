        ...
        <div class="box">
          ...
          <form role="form" action="" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="store">Hoạt động</label>
                  <select class="form-control" id="active" name="active"> 
                    <option value="1" <?php if($product_data['active'] == 1) { echo 'selected="selected"'; } ?>>Có</option>
                    <option value="2" <?php if($product_data['active'] == 2) { echo 'selected="selected"'; } ?>>Không</option>
                  </select>
                </div>
